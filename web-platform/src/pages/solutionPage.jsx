...
const SolutionPage = () => {
  return (
    <div className='w-full h-full flex'>
      ...
      <div className='w-1/5 px-6 py-6 h-screen flex flex-col gap-3 align-center'>
        ...
        <div>
          <ul className='flex flex-col gap-2'>
            <div className='text-[#787486] text-lg font-medium hover:bg-[#00B9DA14] px-2 py-1 hover:text-[#3A3946] hover:rounded-lg cursor-pointer'><p>Home</p></div>
      ...
      {/* Main */}
      <div className='w-full h-screen bg-[#f5f5f5] flex flex-col gap-10 justify-start items-start px-12 py-8'>
        <h2 className='text-3xl text-black font-bold'>Detected Spills</h2>
